...
(defvar prd-highlight-keyword-warn-keywords "\\<\\(FIXME\\|TODO\\|TEST\\|NOTE\\|NOTES\\|NB\\|WARN\\|WARNING\\|BUG\\|HACK\\|ASK\\|EYESORE\\|BAD\\|FIXME\\|REVIEW\\):")
...
(defvar prd-highlight-keyword-modes
  '(ada-mode c-mode emacs-lisp-mode java-mode haskell-mode web-mode
             ...
             yaml-mode clojure-mode clojurescript-mode))
