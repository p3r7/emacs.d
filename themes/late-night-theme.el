...
(custom-theme-set-faces
 ...
 ;; `(default ((t (nil))))
 `(default ((t (:stipple nil :background "#000" :foreground "#666" :inverse-video nil :box nil :strike-through nil :overline nil :underline nil :slant normal :weight normal :width semi-condensed))))
 `(bold ((t (:bold t))))
 `(button ((t (:bold t))))
