;;; comidia-mod-theme.el --- Comidia Color Theme

(deftheme comidia-mod
  "Color theme by Marcelo Dias de Toledo, created 2001-12-17.
Modified by p3r7 in 2015.
Steel blue on black.")
...
(custom-theme-set-faces
 'comidia-mod
 `(default ((t (:stipple nil :background "Black" :foreground "SteelBlue" :inverse-video nil :box nil :strike-through nil :overline nil :underline nil :slant normal :weight normal :width semi-condensed))))
 `(bold ((t (:bold t :weight bold))))
 `(bold-italic ((t (:italic t :bold t :slant italic :weight bold))))
 `(border ((t (:background "black"))))
 `(cursor ((t (:background "SteelBlue"))))
 `(highlight ((t (:background "#333300"))))
 ...
 `(mode-line-inactive ((t (:background "#1A1A1A" :foreground "#4D4D4D" :box (:line-width -1) ))))
...
(eval-after-load 'term
  `(setq ansi-term-color-vector
         (vector 'unspecified ,"#000000" ,"#ffc0cb" ,"#66cdaa" ,"#ff7f24"
		 ,"#4682b4" ,"#8b6599" ,"#00ffff" ,"#b0c4de"))
)

(custom-theme-set-variables
 'comidia-mod
 `(ansi-color-names-vector ["#000000" "#ffc0cb" "#66cdaa" "#ff7f24"
			    "#4682b4" "#8b6599" "#00ffff" "#b0c4de"])
 )

(provide-theme 'comidia-mod)

;; Local Variables:
;; no-byte-compile: t
;; End:

;;; comidia-mod-theme.el ends here
